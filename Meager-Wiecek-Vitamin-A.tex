...
%However, the choice between RE and FE is also affected by the presence of non-i.i.d or non-exchangeable studies. In this paper we will examine how the presence of outliers, publication bias and related econometric concerns affects each method's performance. Because FE assigns higher weight to more precise studies irrespective of their cohesion with the rest of the effect distribution, it can be more affected by certain types of outliers. But because RE assigns higher weights to less precise studies, it can be more affected by publication bias, which tends to affect smaller, noisier settings.
...
%Further details of the DGPs are in Appendix B. 
...
%The full results are shown in the Appendix and summarized in graphs that follow. 
...
%Of course, as shown in table \ref{table:simulations} in the Appendix, 

...
The model suggests that the underlying heterogeneity across studies is large (66\% of the cross-study variation attributable to genuine differences in treatment effects), but this is not precisely estimated.  
...
\begin{table}
\label{summary table}
\caption{Input data and study-level results for BHM based on studies included in Imdad et al (2022).}
\begin{tabular}[t]{lrrrrrrrr}
\toprule
\multicolumn{1}{c}{} & \multicolumn{5}{c}{Inputs (risk ratio)} & \multicolumn{3}{c}{RE posterior (risk ratio)} \\
\cmidrule(l{3pt}r{3pt}){2-6} \cmidrule(l{3pt}r{3pt}){7-9}
Study & mean & LCI & UCI & log(RR) & SE(log(RR)) & mean & LCI & UCI\\
\midrule
...
\toprule
  & Hypermean & p.p.d.\\
\midrule
\textbf{Partial, all data} & \textbf{0.75 (0.6, 0.89)} & \textbf{0.78 (0.4, 1.3)}\\
Partial, no DEVTA & 0.73 (0.59, 0.86) & 0.76 (0.39, 1.3)\\
Full, all data & 0.88 (0.83, 0.93) & 0.88 (0.83, 0.93)\\
Full, no DEVTA & 0.77 (0.7, 0.84) & 0.77 (0.7, 0.84)\\
\bottomrule
\end{tabular}
\end{table}

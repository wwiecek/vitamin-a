...
%RM: i reworded, if you approve then uncomment, if not then delete it 
%When underlying treatment effects are genuinely heterogeneous across studies, it is typically undesirable to let any single estimated treatment effect have overwhelming influence on this average even if it is much more precise than the others, since each study still represents only one data point from the underlying distribution of treatment effects. 
...
%RM: i did so, check it out, lmk if any issues or confusion 
...
%WW: Q to Rachael: how do we support the claim about the normal fitting well? Maybe later part of this paragraph is not necessary
%RM: yeah good point, I would delete this whole paragraph, unless you see some reason to keep it. 
...
%WW: Q to Rachael: how would you justify this next sentence? Also, should we move references from the previous para to earlier in the text?
%RM: I deleted the sentence, you were right. You can move the cites up, if you like, or can just delete them.
